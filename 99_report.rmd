...
I am performing the same procedure for perturbations to the dive durations, but it isn't complete at time of writing. I can see from my log files that currently 77/77 models include a surface response, and that at least some of the models include a dive response, but not all.
...
1. My suspicion is the model is having difficulty with large solitary spikes, perhaps a more adaptive procedure for setting the number of knots could help? Or manual tweaking of knots for each individual?
1. other ideas...?
